package cohen.dafna.weatherfinalexam.services
...
import cohen.dafna.weatherfinalexam.location.LocationRepository
import cohen.dafna.weatherfinalexam.util.NotificationHelper
                    ...
                    .onEach {
                        ...
                        if (serviceRunningInForeground) {
                            notificationManager.notify(
                                NOTIFICATION_ID,
                                NotificationHelper(this@ForegroundOnlyLocationService).generateNotification(
                                    currentLocation
                                )
                            )
                        }
